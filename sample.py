...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str, default="/remote-home/wangyu/VQ-PAR/log_par/learn_all[main-572fdc6]_2025_04_27__17_45_18/checkpoints/6000.pt")
    ...
    if args.debug:
        ...
        res_dir = os.path.join(log_dir, 'results')
    ...
    for batch_idx, batch in enumerate(tqdm(val_loader, desc='Validate', dynamic_ncols=True)):
        ...
        for sp_idx in tqdm(range(args.sample_num), desc="Generating Multiple Samples", dynamic_ncols=True):
            final = model.autoregressive_infer_cfg(batch, cfg=0.1, top_k=5, top_p=0.9)
